...
if ($PAGE->theme->settings->coursetilestyle < 10) {
    class course_renderer extends core_course_renderer {
        ...
        public function view_available_courses($id = 0, $courses = null, $totalcount = null) {
            ...
            if ($this->page->theme->settings->coursetilestyle == 8) {
            ...
            if (count($rcourseids) > 0) {
                foreach ($acourseids as $courseids) {
                    ...
                    foreach ($courseids as $courseid) {
                        ...
                        $trimtitlevalue = $this->page->theme->settings->trimtitle;
                        $trimsummaryvalue = $this->page->theme->settings->trimsummary;
                        ...
                        $noimgurl = $this->output->image_url('noimg', 'theme');
                        ...
                        if (progress::get_course_progress_percentage($course) &&
                            isloggedin() &&
                            $systemcontext == 'page-site-index') {
                            $comppc = progress::get_course_progress_percentage($course);
                        ...
                        if ($course->enablecompletion == 1 && isloggedin() && $systemcontext == 'page-site-index') {
                            ...
                            $compbar .= "<div class='progress-bar progress-bar-info barfill' " .
                                "role='progressbar' aria-valuenow='{$comppercent}' ";
                        ...
                        if ($icons = enrol_get_course_info_icons($course)) {
                            $pixcontent .= html_writer::start_tag('div', ['class' => 'enrolmenticons']);
                        ...
                        if ($cat = core_course_category::get($course->category, IGNORE_MISSING)) {
                            $catcontent = html_writer::start_tag('div', ['class' => 'coursecat']);
                        ...
                        // Load from config if a img from course summary file if not exist use a fa-icon.
                        $imgurl = '';
                        ...
                        if (empty($imgurl)) {
                            $imgurl = $this->page->theme->setting_file_url('headerdefaultimage',
                                'headerdefaultimage',
                                true);
                            if (!$imgurl) {
                                $imgurl = $noimgurl;
                        ...
                        if ($course->has_custom_fields()) {
                            ...
                            $customfieldcontent = html_writer::tag('div',
                                $customfields,
                                ['class' => 'customfields-container']);
                        }

                        if ($this->page->theme->settings->coursetilestyle == 1) {
                            $rowcontent .= '
                        <div class="col-md-4">';
                            ...
                            <div class="class-box">
                                ';
                            if ($this->page->theme->settings->titletooltip) {
                                $tooltiptext = 'data-tooltip="tooltip" data-placement= "top" title="' .
                            ...
                            $rowcontent .= '
                                    ...
                                    <div class="course-image-view" style="
                        ...
                        if ($this->page->theme->settings->coursetilestyle == 2) {
                            ...
                            $rowcontent .= '<div class="tilecontainer"><figure class="coursestyle2">
                                <div class="class-box-courseview" style="
                                background-image: url(' . $imgurl . ');
                                background-repeat: no-repeat;
                                background-size:cover;
                                background-position:center;">';
                            ...
                            $rowcontent .= '<figcaption><h3>' . $trimtitle . '</h3><div class="course-card">' .
                                $catcontent . ' ' . $customfieldcontent .
                                '<button type="button" class="btn btn-primary btn-sm coursestyle2btn">' .
                                $enrollbutton .
                            ...
                            $rowcontent .= '</div></figcaption><a ' . $tooltiptext . ' href="' . $courseurl .
                                '" class="coursestyle2url"></a></div></figure></div></div>';
                        }
                        if ($this->page->theme->settings->coursetilestyle == 3) {
                            if ($this->page->theme->settings->titletooltip) {
                                $tooltiptext = 'data-toggle="tooltip" data-placement= "top" title="' .
                                    format_string($course->fullname) . '"';
                            } else {
                            ...
                            $rowcontent .= '<div class="col-md-4"><div class="tilecontainer">
	                            <div class="class-box-fp-style3" style="
	                            background-image: url(' . $imgurl . ');
	                            background-repeat: no-repeat;
	                            background-size:cover;
	                            background-position:center;">';
                            ...
                            $rowcontent .= '<div class="course-title"><a ' . $tooltiptext . ' href="' .
                                $courseurl . '"><h4>' . $trimtitle . '</h4></a>' .
                                $catcontent . ' ' . $customfieldcontent .
                                '<div class="completiontextposition">' . $completiontext . '</div></div>' .
                                $progressbar . '</div></div></div></div>';
                        }
                        if ($this->page->theme->settings->coursetilestyle == 4) {
                            $rowcontent .= '
                        <div class="col-md-4">';
                            $rowcontent .= html_writer::start_tag('div',
                                [
                            ...
                            $rowcontent .= '<a ' . $tooltiptext . ' href="' . $courseurl . '">
                                    ...
                                    <div class="course-overlay">
                                    <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                                    </div></div><div class="course-title4"><h4>' .
                                $trimtitle . '</h4></div></a><div class="course-summary4">' .
                                $catcontent . ' ' . $customfieldcontent . ' ' . $summary;
                            if ($course->has_course_contacts()) {
                                $rowcontent .= html_writer::start_tag('ul',
                                    [
                                        'class' => 'teacherscourseview'
                        ...
                        if ($this->page->theme->settings->coursetilestyle == 5) {
                            $rowcontent .= html_writer::start_tag('div',
                                [
                            ...
                            $rowcontent .= '<div class="col-md-4">';
                            $rowcontent .= '<a ' . $tooltiptext . ' href="' . $courseurl .
                                '"><div class="course-title-fullbox"><h4>' . $trimtitle . '</h4></a></div>';
                            if ($course->has_course_contacts()) {
                                $rowcontent .= html_writer::start_tag('ul', ['class' => 'teacherscourseview']);
                                foreach ($course->get_course_contacts() as $userid => $coursecontact) {
                                    $name = $coursecontact['rolename'] . ': ' . $coursecontact['username'];
                                    $rowcontent .= html_writer::tag('li', $name);
                                }
                        ...
                        if ($this->page->theme->settings->coursetilestyle == 6) {
                            if ($this->page->theme->settings->titletooltip) {
                                $tooltiptext = 'data-toggle="tooltip" data-placement= "top" title="' .
                                    format_string($course->fullname) . '"';
                            } else {
                            ...
                            $rowcontent .= '<div class="col-md-12"><div class="class-fullbox" style="
                            background-image: url(' . $imgurl . ');
                            background-repeat: no-repeat;
                            background-size:cover;
                            background-position:center;"><div class="fullbox">';
                            $rowcontent .= html_writer::start_tag('div',
                                [
                                    'class' => $course->visible ? 'coursevisible' : 'coursedimmed3'
                                ]);
                            ...
                            $rowcontent .= '<div class="col-md-6"><div class="course-summary">' . $summary .
                                '</div></div></div></div>';
                            $rowcontent .= '</div></div></div>';
                        }
                        if ($this->page->theme->settings->coursetilestyle == 7) {
                            if ($this->page->theme->settings->titletooltip) {
                                $tooltiptext = 'data-toggle="tooltip" data-placement= "top" title="' .
                                    format_string($course->fullname) . '"';
                            } else {
                            ...
                            $rowcontent .= '
                        <div class="col-md-12">
                            <div class="class-fullbox7" style="
                            background-image: url(' . $imgurl . ');
                            background-repeat: no-repeat;
                            background-size:cover;
                            background-position:center;
                            ...
                            $rowcontent .= '</div></div></div></div></div>';
                        }
                        if ($this->page->theme->settings->coursetilestyle == 8) {
                            ...
                            $rowcontent .= '<div class="col-lg-6"><div class="tilecontainer">';
                            $rowcontent .= html_writer::start_tag('div',
                                [
                                    'class' => $course->visible ? 'coursevisible' : 'coursedimmed3'
                                ]);
                            $rowcontent .= '<div class="class-box-fp-2col" style="
                            background-image: url(' . $imgurl . ');
                            background-repeat: no-repeat;
                            background-size:cover;
                            background-position:center;"><a ' . $tooltiptext . ' href="' . $courseurl .
                                '" class="coursestyle3url">';
                            $rowcontent .= '<div class="course-title-2col">
                                    <h4><a href="' . $courseurl . '">' . $trimtitle . '</a></h4>
                                    ' . $catcontent . ' ' . $customfieldcontent . '</div>
                                    <div class="course-summary-2col">' . $summary . '</div></div></a></div></div></div>';
                        }
                        if ($this->page->theme->settings->coursetilestyle == 9) {
                            if ($this->page->theme->settings->titletooltip) {
                                $tooltiptext = 'data-toggle="tooltip" data-placement= "top" title="' .
                                    format_string($course->fullname) . '"';
                            } else {
                            ...
                            $rowcontent .= '<div class="col-md-6"><h4><a href="' . $courseurl . '">' .
                                $trimtitle . '</a></h4>';
                            ...
                            $rowcontent .= '</div>';
                            if ($systemcontext !== 'page-site-index') {
                                $rowcontent .= '<div class="col-md-6 row"><div class="col-md-6">' .
                                    $catcontent . ' ' . $customfieldcontent . '</div><div class="col-md-6">';
                                if ($course->has_course_contacts()) {
                                    $rowcontent .= html_writer::start_tag('ul', ['class' => 'teacherscourseview']);
                                    foreach ($course->get_course_contacts() as $userid => $coursecontact) {
                                        $name = $coursecontact['rolename'] . ': ' . $coursecontact['username'];
        ...
        protected function coursecat_category(coursecat_helper $chelper, $coursecat, $depth) {
            ...
            if ($this->countcategories == 0 || ($this->countcategories % 3) == 0) {
                ...
                if ($totalcount != $this->countcategories || $this->countcategories == 0) {
                    ...
                    if ($categoryparam) {
                        $content .= $this->output->heading(get_string('categories'));
                    }
                    $content .= '<div class="container-fluid"><div class="row">';
                }
            }
            $classes[] = 'col-md-3 box-class';
            $content = '<div class="' . join(' ', $classes) .
                '" data-categoryid="' . $coursecat->id . '" data-depth="' . $depth .
                '" data-showcourses="' . $chelper->get_show_courses() . '" data-type="' .
                self::COURSECAT_TYPE_CATEGORY . '">';
            ...
            if ($chelper->get_show_courses() == self::COURSECAT_SHOW_COURSES_COUNT) {
                ...
                $content .= '  <span class="numberofcourses" title="' . get_string('numberofcourses') .
                    '">(' . $coursescount . ')</span>';
            }
            $content .= '</div>';
            $content .= '</div>';
        ...
        protected function coursecat_subcategories(coursecat_helper $chelper, $coursecat, $depth) {
            ...
            if ($totalcount > count($subcategories)) {
                if ($paginationurl) {
                    ...
                    $this->page = $chelper->get_categories_display_option('offset') / $perpage;
                    $pagingbar = $this->paging_bar($totalcount,
                        $this->page,
                        $perpage,
                        $paginationurl->out(false,
                            [
                                'perpage' => $perpage
                            ]));
                    if ($paginationallowall) {
                        $pagingbar .= html_writer::tag('div',
                            html_writer::link($paginationurl->out(false,
                                [
                                    'perpage' => 'all'
                                ]),
                    ...
                    // The option 'viewmoreurl' was specified, display more link,
                    // if it is link to category view page, add category id.
                    if ($viewmoreurl->compare(new moodle_url('/course/index.php'), URL_MATCH_BASE)) {
                        $viewmoreurl->param('categoryid', $coursecat->id);
                    }
                    $viewmoretext = $chelper->get_categories_display_option('viewmoretext',
        ...
        protected function coursecat_courses(coursecat_helper $chelper, $courses, $totalcount = null) {
            ...
            if ($totalcount > count($courses)) {
                if ($paginationurl) {
                    ...
                    $this->page = $chelper->get_courses_display_option('offset') / $perpage;
                    $pagingbar = $this->paging_bar($totalcount,
                        $this->page,
                        $perpage,
                        $paginationurl->out(false,
                    ...
                    $morelink = html_writer::tag('div',
                        html_writer::tag('a',
                            html_writer::start_tag('i',
                                ...
                                ]) . html_writer::end_tag('i') . $viewmoretext,
                            [
                                'href' => $viewmoreurl,
        ...
        public function frontpage_my_courses() {
            ...
            if (!empty($courses) || !empty($rcourses) || !empty($rhosts)) {
                ...
                $this->output .= $this->coursecat_courses($chelper, $courses, $totalcount);
                // MNET.
                if (!empty($rcourses)) {
                    // At the IDP, we know of all the remote courses.
                    $this->output .= html_writer::start_tag('div',
                        [
                            'class' => 'courses'
                        ]);
                    foreach ($rcourses as $course) {
                        $this->output .= $this->frontpage_remote_course($course);
                    }
                    $this->output .= html_writer::end_tag('div'); // Css .courses ?
                    ...
                    foreach ($rhosts as $host) {
                        $this->output .= $this->frontpage_remote_host($host);
                    }
                    $this->output .= html_writer::end_tag('div'); // Css .courses ?
